...
export default function MenuItemReviewCreatePage({ storybook = false }) {
  ...
  const onSuccess = (menuItemReview) => {
    toast(
      `New menuItemReview Created - id: ${menuItemReview.id} itemId: ${menuItemReview.itemId} reviewerEmail: ${menuItemReview.reviewerEmail} stars: ${menuItemReview.stars} dateReviewed: ${menuItemReview.dateReviewed} comments: ${menuItemReview.comments}`,
    );
  };
